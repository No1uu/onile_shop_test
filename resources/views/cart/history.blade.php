            ...
            <div class="main-data p-8 sm:p-14 bg-gray-50 rounded-3xl">
                ...
                <div class="grid grid-cols-8 pb-9">
                    ...
                    <div class="col-span-1 max-lg:hidden flex items-center justify-center">
                        <p class="font-medium text-lg leading-8 text-gray-600">Тоо хэмжээ
                        </p>
                    </div>
                ...
                @forelse ($orders as $order)
                    @foreach($order->cart->items as $item)
                        <div class="box p-8 rounded-3xl bg-gray-100 grid grid-cols-8 mb-7 cursor-pointer transition-all duration-500 hover:bg-indigo-50 max-lg:max-w-xl max-lg:mx-auto">
                            <div class="col-span-8 sm:col-span-4 lg:col-span-1 sm:row-span-4 lg:row-span-1">
                                <img src="{{Storage::url($item->product->image)}}" alt="Product image" class="max-lg:w-auto max-sm:mx-auto rounded-xl object-cover">
                            </div>
                            <div class="col-span-8 sm:col-span-4 lg:col-span-3 flex h-full justify-center pl-4 flex-col max-lg:items-center">
                                ...
                                <p class="font-normal text-base leading-7 text-gray-600 max-md:text-center">
                                    White
                                </p>
                            </div>
                            <div class="col-span-8 sm:col-span-4 lg:col-span-1 flex items-center justify-center">
                                <p class="font-semibold text-xl leading-8 text-black">${{ number_format($item->product->price) }}</p>
                            </div>
                            <div class="col-span-8 sm:col-span-4 lg:col-span-1 flex items-center justify-center">
