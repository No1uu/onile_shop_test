                ...
                <div class="flex -mx-2 mb-4">
                    <div class="w-1/2 px-2">
                        <form action="{{route('cart.add')}}" method="POST">
                            ...
                            <button type="submit" class="w-full bg-gray-900 dark:bg-gray-600 text-white py-2 px-4 rounded-full font-bold hover:bg-gray-800 dark:hover:bg-gray-700">Сагслах</button>
                        </form>
                    </div>
                <div class="w-1/2 px-2">
...
<div class="antialiased mx-auto mt-8">
  ...
  <!-- comment form -->
<div class="flex  mx-auto items-center justify-center shadow-lg mt-8 mx-14 mb-4">
   <form action="{{route('comment.store',['id'=> $product->id])}}" method="POST"class="w-full bg-white rounded-lg px-4 pt-2">
    @csrf
      <div class="flex flex-wrap -mx-3 mb-6">
         <div class="w-full md:w-full px-3 mb-2 mt-2">
            <textarea name="comment" class="bg-gray-100 rounded border border-gray-400 leading-normal resize-none w-full h-20 py-2 px-3 font-medium placeholder-gray-700 focus:outline-none focus:bg-white" name="body" placeholder='Сэтгэгдлээ үлдээнэ үү.' required></textarea>
         </div>
